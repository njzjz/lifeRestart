...
class App{
    ...
    initPages() {
        ...
        <div id="main">
            ...
            <button id="random" class="mainbtn" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);">抽什么抽，直接选！</button>
            <ul id="talents" class="selectlist"></ul>
            <button id="next" class="mainbtn">请选择任意个</button>
        </div>
        `);
        ...
        <div id="main">
            ...
            <div class="btn-area">
                <button id="random" class="mainbtn">直接加满</button>
        ...
        const freshTotal = ()=>{
            propertyPage.find('#total').text(`你可以用任意多个属性点`);
        }
        ...
        <div id="main">
            ...
            <div class="head" style="top:auto; bottom:35%; display:none">天赋，你可以选一个，下辈子还能抽到</div>
            <ul id="talents" class="selectlist" style="top:calc(65% + 0.5rem); bottom:8rem; display:none">
